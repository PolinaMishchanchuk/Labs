...
public class Serialisator {
    public boolean serialization(Phaser n, String fileName) {
        boolean flag = false;
    ...
    public Phaser deserialization(String fileName) throws InvalidObjectException {
        ...
        try {
            ...
            // десериализация
            Phaser nas = (Phaser) istream.readObject();
            return nas;
